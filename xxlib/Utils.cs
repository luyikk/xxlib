...
namespace xx
{
    ...
    public static class Utils
    {
        ...
        /// <summary>
        /// UTC时间转换成等价的本地时间返回时间戳
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        public static long UTCTimeToLocalTimeEpoch10m(this DateTime dt)
        {
            if (dt.Kind == DateTimeKind.Utc)
            {
                var m = new DateTime(dt.Year, dt.Month, dt.Day, dt.Hour, dt.Minute, dt.Second, DateTimeKind.Local);
                return m.ToUniversalTime().Ticks - 621355968000000000;
            }
